...
class SliderMrMetaBoxes{
  ...
  <h4 style="font-size: 16px; font-weight: bold; margin-bottom: 10px;">Dinamic Shortcode</h4>
    ...
    <input type='text' class='widefat' value='[SLIDER_SHORTCODE id="<?php echo esc_attr( $post->ID ); ?>"]' readonly="">
    ...
    function column_data($column, $post_id){
        switch ( $column ) {
            ...
            case 'slider_post_column' :
				...
				echo '<input type="text" class="widefat" value=\'[SLIDER_SHORTCODE id="' . esc_attr( $post_id ) . '"]\' readonly="">';
