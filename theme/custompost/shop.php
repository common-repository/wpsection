...
trait ShopPostType {
    ...
    public function register_post_type() {
        ...
        $labels = array(
            ...
            'singular_name'         => _x( 'Shop Template', 'Post Type Singular Name', 'wpsection' ),
            'menu_name'             => __( 'Shop Tmplt', 'wpsection' ),
...
class ShopMrMetaBoxes{
  ...
  <h4 style="font-size: 16px; font-weight: bold; margin-bottom: 10px;">Dinamic Shortcode</h4>
    ...
    <input type='text' class='widefat' value='[SHOP_SHORTCODE id="<?php echo esc_attr( $post->ID ); ?>"]' readonly="">
    ...
    function column_data($column, $post_id){
        switch ( $column ) {
            ...
            case 'shop_post_column' :
				...
				echo '<input type="text" class="widefat" value=\'[SHOP_SHORTCODE id="' . esc_attr( $post_id ) . '"]\' readonly="">';
