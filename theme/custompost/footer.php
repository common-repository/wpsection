...
trait FooterPostType {
    ...
    public function register_post_type() {
        ...
        $labels = array(
            ...
            'menu_name'             => __( 'Footer Tmplt', 'wpsection' ),
...
class FooterMrMetaBoxes{
  ...
  <h4 style="font-size: 16px; font-weight: bold; margin-bottom: 10px;">Dinamic Shortcode</h4>
    ...
    <input type='text' class='widefat' value='[FOOTER_SHORTCODE id="<?php echo esc_attr( $post->ID ); ?>"]' readonly="">
    ...
    function column_data($column, $post_id){
        switch ( $column ) {
            ...
            case 'footer_post_column' :
				...
				echo '<input type="text" class="widefat" value=\'[FOOTER_SHORTCODE id="' . esc_attr( $post_id ) . '"]\' readonly="">';
