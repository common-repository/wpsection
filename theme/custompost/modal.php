...
trait ModalPostType {
    ...
    public function register_post_type() {
        ...
        $labels = array(
            ...
            'singular_name'         => _x( 'Modal Template', 'Post Type Singular Name', 'wpsection' ),
            'menu_name'             => __( 'Modal Tmplt', 'wpsection' ),
...
class ModalMrMetaBoxes{
  ...
  <h4 style="font-size: 16px; font-weight: bold; margin-bottom: 10px;">Dinamic Shortcode</h4>
    ...
    <input type='text' class='widefat' value='[MODAL_SHORTCODE id="<?php echo esc_attr( $post->ID ); ?>"]' readonly="">
    ...
    function column_data($column, $post_id){
        switch ( $column ) {
            ...
            case 'modal_post_column' :
				...
				echo '<input type="text" class="widefat" value=\'[MODAL_SHORTCODE id="' . esc_attr( $post_id ) . '"]\' readonly="">';
