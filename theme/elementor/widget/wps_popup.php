...
<!-- This is the Main Area Start =================== -->
<div class="defult_five mr_popup <?php echo esc_attr($settings['sec_class']); ?>">
    
    <div class="defult_popup">
        
        <!-- Slider Mask =================== -->
        <button class="open-popup popup_button"><?php echo esc_html($settings['popup_title']); ?></button>
        <div class="popup-overlay">
            <div class="popup-content">
                <button class="close-popup">&times;</button>
                <?php echo do_shortcode($settings['popup_shortocde']); ?>
            </div>
        </div>
        <!-- End Slider Mask =================== -->
