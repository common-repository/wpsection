    ...
    <div class="wpsection-pricing wpsection-pricing-<?php echo esc_attr($settings['sec_class']); ?>">
        <div class="pricing-head">
            <div class="pricing-icon">
                <?php if ('choose_image' === $settings['choose_media'] && !empty($settings['image']['id'])) : ?>
            ...
            <h4 class="pricing-duration"><?php echo esc_html($settings['highlighted_text']); ?></h4>

            <div class="price">
                <span class="sale-price">
                    <span class="currency"><?php echo esc_html($settings['currency']); ?></span><?php echo esc_html($settings['sale_price']); ?>
                </span>

                <span class="regular-price">
                    <span class="currency"><?php echo esc_html($settings['currency']); ?></span><?php echo esc_html($settings['regular_price']); ?>
                </span>
            </div>
            <h3 class="pricing-title"><?php echo esc_html($settings['short_desc']); ?></h3>
        </div>

        <div class="pricing-content">
            <ul>
                <?php foreach ($settings['repeat'] as $item) : ?>
                    <li class="<?php echo esc_attr('feature_in'); ?>"><span class="check-close-icon"></span><?php echo esc_html($item['feature_text']); ?></li>
                <?php endforeach; ?>
            </ul>
        </div>
