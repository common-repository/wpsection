...
<div class="feature-block mr_featured_section <?php echo esc_attr( $settings['sec_class'] ); ?>">
    ...
    <div class="mr_featured_block inner-box hvr-float-shadow wow fadeInUp" data-wow-duration="1500ms">
        ...
        <h4 class="mr_block_title"><a href="<?php echo esc_url( $settings['btnlink']['url'] ); ?>"><?php echo esc_html( $settings['title'] ); ?></a></h4>

        <p class="mr_f_block_text"><?php echo esc_html( $settings['text'] ); ?></p>

        <div class="mr_block_bttn btn-box clearfix">
            <a href="<?php echo esc_url( $settings['btnlink']['url'] ); ?>" class="mr_btton_a theme-btn btn-style-one"><?php echo esc_html( $settings['bttn'] ); ?><i class="flaticon-right-arrow"></i></a>
        </div>
