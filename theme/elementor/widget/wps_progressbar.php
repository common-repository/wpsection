...
<?php if ('style1' === $settings['style']) : ?>
    <div id="wpsection-progress-bar" class="wpsection-progress-bar wpsection-progress-bar-<?php echo esc_attr($settings['sec_class']); ?>">
        <div class="wpsection-progress-fill" role="progressbar" aria-valuenow="<?php echo esc_attr($settings['pb_value']); ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo esc_attr($settings['pb_value']) . '%'; ?>">

            <span class="wpsection-pb-label"><?php echo esc_html($settings['pb_label']); ?></span>

            <span class="wpsection-pb-percent"><?php echo esc_html($settings['pb_value']) . '%'; ?></span>
...
<?php if ('style2' === $settings['style']) : ?>
    <div id="wpsection-progress-bar" class="wpsection-progress-bar wpsection-progress-bar-<?php echo esc_attr($settings['sec_class']); ?>">
        ...
        <span class="wpsection-pb-start-label"><?php echo esc_html($settings['start_label']); ?></span>
            ...
            <div class="wpsection-progress-fill" role="progressbar" aria-valuenow="<?php echo esc_attr($settings['pb_value']); ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo esc_attr($settings['pb_value']) . '%'; ?>">
                ...
                <div class="wpsection-pb-indicator">
                    <?php if (wp_get_attachment_url($settings['image']['id'])) : ?>
                        <img src="<?php echo esc_url(wp_get_attachment_url($settings['image']['id'])); ?>" alt="<?php echo esc_attr($settings['pb_value']); ?>" />
                    <?php else : ?>
        ...
        <span class="wpsection-pb-end-label"><?php echo esc_html($settings['end_label']); ?></span>
