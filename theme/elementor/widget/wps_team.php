    ...
    <div id="wpsection-team" class="wpsection-team wpsection-team-<?php echo esc_attr($settings['sec_class']); ?>">
        ...
        <div class="wpsection-team-img">
            <?php if (wp_get_attachment_url($settings['image']['id'])) : ?>
                <img src="<?php echo esc_url(wp_get_attachment_url($settings['image']['id'])); ?>" />
            <?php else : ?>
        ...
        <div class="wpsection-team-info">
            <h3 class="wpsection-team-name"><?php echo esc_html($settings['title']); ?></h3>
            <span class="wpsection-team-designation"><?php echo esc_html($settings['subtitle']); ?></span>
            <div class="wpsection-team-social">
                <?php foreach ($settings['repeat'] as $item) : ?>
                    <li>
                        <a href="<?php echo esc_url($item['block_btnlink']['url']); ?>">
                            <?php if (is_string($item['block_icons'])) : ?>
                                <i class="<?php echo esc_attr(str_replace("fa ", "fa", $item['block_icons'])); ?>"></i>
                            <?php endif; ?>
                        </a>
                    </li>
                <?php endforeach; ?>
    ...
    <div class="wpsection-team wpsection-team-<?php echo esc_attr($settings['sec_class']); ?>">
        ...
        <div class="wpsection-team-info">
            ...
            <div class="wpsection-team-contact">
                <a href="#"><?php echo esc_html($settings['tel_no']); ?></a>
                <a href="#"><?php echo esc_html($settings['email']); ?></a>
            </div>
            <div class="wpsection-team-short-desc"><?php echo wp_kses_post($settings['_content']); ?></div>
            <div class="wpsection-team-social">
                <?php foreach ($settings['repeat'] as $item) : ?>
                    <li>
                        <a href="<?php echo esc_url($item['block_btnlink']['url']); ?>">
    ...
    <div id="wpsection-team" class="wpsection-team wpsection-team-<?php echo esc_attr($settings['sec_class']); ?>">
        ...
        <div class="wpsection-team-info">
            ...
            <div class="wpsection-team-rating">
                ...
                <?php endfor; ?>
                <span class="wpsection-team-rating-count"><?php echo esc_html($settings['review_ctext']); ?></span>
            </div>
            <div class="wpsection-team-experience"><?php echo esc_html($settings['experience']); ?></div>
            <div class="wpsection-team-social">
                <?php foreach ($settings['repeat'] as $item) : ?>
                    <li>
                        <a href="<?php echo esc_url($item['block_btnlink']['url']); ?>">
