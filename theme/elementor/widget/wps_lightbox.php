...
<section class="wps_video_popup">
    <div class="video-popup-box" style="background-image: url('<?php echo esc_url(wp_get_attachment_url($settings['wps_lightbox_image']['id'])); ?>');">
        <div class="inner-column">
            <div class="image">
                <img src="<?php echo esc_url(wp_get_attachment_url($settings['wps_lightbox_image']['id'])); ?>" alt="">
            </div>
