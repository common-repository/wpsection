...
<script>
  jQuery(document).ready(function($)
  {
    ...
    if (enableSlide) {
      ...
      $(".' .  esc_js( $widget_id ) . ' .project-carousel").owlCarousel({
        loop:true,
        margin:15,
        smartSpeed: 500,
    ...
    $(".' . esc_js( $widget_id ) . ' .tab-navigation a").on("click", function(e) {
      e.preventDefault();

      // Remove active class from all tabs
      $(".' . esc_js( $widget_id ) . ' .tab-navigation a").removeClass("active");

      // Add active class to the clicked tab
      $(this).addClass("active");

      // Hide all tab content panes
      $(".' . esc_js( $widget_id ) . ' .tab-content .tab-pane").hide();
    ...
    $(".' . esc_js( $widget_id ) . ' .tab-navigation a:first").addClass("active");
    $(".' . esc_js( $widget_id ) . ' .tab-content .tab-pane:first").show();
  });
</script>';
?>
...
<div class="wps_tab_container">
  <ul class="tab-navigation wps_tab_ul">
    ...
    <?php foreach ($settings['repeater'] as $item) : ?>
      <li class="wps_tab_button">
        <a class="nav-link" href="#tab-<?php echo esc_attr($tab_counter); ?>">
          <?php echo esc_html($item['tab_block_title_one']); ?>
        </a>
      </li>
      <?php $tab_counter++; ?>
    <?php endforeach; ?>
...
<div class="tab-content">
  <?php $tab_counter = 1; ?>
  <?php foreach ($settings['repeater'] as $item) : ?>
    <div id="tab-<?php echo esc_attr($tab_counter); ?>" class="tab-pane">
...
<?php if ('yes' === $item['tab_settings_one']) : ?>			  
            <!-- item One -->
 <div class="project-block-one <?php echo esc_attr($settings['enable_slide'] ? '' : $columns_markup_print); ?>">
        ...
        <div class="inner-box mr_block_bttn mr_btton_a wps_overlay_style_1">
            <figure class="image-box wps_image_box">
                <?php if (wp_get_attachment_url($item['block_image_one']['id'])) : ?>
                    <img class="mr_product_thumb" src="<?php echo esc_url(wp_get_attachment_url($item['block_image_one']['id'])); ?>" alt="">
                <?php else : ?>
            ...
            <div class="content-box">
                <div class="wps_project_icon view-btn">
                    <?php if (!empty($settings['block_plus_icon']['value'])) : ?>
                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_one']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                ...
                <?php if ('style-1' === $settings['text_box_style'] || 'style-2' === $settings['text_box_style']) : ?>
                    <div class="text_outside_box">
                        <div class="text-box">
                            <?php if ('style-1' === $settings['text_title_style'] || 'style-2' === $settings['text_title_style']) : ?>
                            ...
                            <?php endif; ?>
                            <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle_one']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="inner-box mr_block_bttn mr_btton_a wps_overlay_style_1">
            <figure class="image-box wps_image_box">
                <?php if (wp_get_attachment_url($item['block_image_two']['id'])) : ?>
                    <img class="mr_product_thumb" src="<?php echo esc_url(wp_get_attachment_url($item['block_image_two']['id'])); ?>" alt="">
                <?php else : ?>
                    <div class="noimage"></div>
                <?php endif; ?>
            </figure>
            <div class="content-box">
                <div class="wps_project_icon view-btn">
                    <?php if (!empty($settings['block_plus_icon']['value'])) : ?>
                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_two']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                            <i class="<?php echo esc_attr($settings['block_plus_icon']['value']); ?>"></i>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($settings['block_link_icon']['value'])) : ?>
                ...
                <?php if ('style-1' === $settings['text_box_style'] || 'style-2' === $settings['text_box_style']) : ?>
                    <div class="text_outside_box">
                        <div class="text-box">
                            ...
                            <?php endif; ?>
                            <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle_two']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="inner-box mr_block_bttn mr_btton_a wps_overlay_style_1">
            <figure class="image-box wps_image_box">
                <?php if (wp_get_attachment_url($item['block_image_three']['id'])) : ?>
                    <img class="mr_product_thumb" src="<?php echo esc_url(wp_get_attachment_url($item['block_image_three']['id'])); ?>" alt="">
                <?php else : ?>
                    <div class="noimage"></div>
                <?php endif; ?>
            </figure>
            <div class="content-box">
                <div class="wps_project_icon view-btn">
                    <?php if (!empty($settings['block_plus_icon']['value'])) : ?>
                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_three']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                            <i class="<?php echo esc_attr($settings['block_plus_icon']['value']); ?>"></i>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($settings['block_link_icon']['value'])) : ?>
                ...
                <?php if ('style-1' === $settings['text_box_style'] || 'style-2' === $settings['text_box_style']) : ?>
                    <div class="text_outside_box">
                        <div class="text-box">
                            ...
                            <?php endif; ?>
                            <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle_three']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="inner-box mr_block_bttn mr_btton_a wps_overlay_style_1">
            <figure class="image-box wps_image_box">
                <?php if (wp_get_attachment_url($item['block_image_four']['id'])) : ?>
                    <img class="mr_product_thumb" src="<?php echo esc_url(wp_get_attachment_url($item['block_image_four']['id'])); ?>" alt="">
                <?php else : ?>
                    <div class="noimage"></div>
                <?php endif; ?>
            </figure>
            <div class="content-box">
                <div class="wps_project_icon view-btn">
                    <?php if (!empty($settings['block_plus_icon']['value'])) : ?>
                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_four']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                            <i class="<?php echo esc_attr($settings['block_plus_icon']['value']); ?>"></i>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($settings['block_link_icon']['value'])) : ?>
                ...
                <?php if ('style-1' === $settings['text_box_style'] || 'style-2' === $settings['text_box_style']) : ?>
                    <div class="text_outside_box">
                        <div class="text-box">
                            ...
                            <?php endif; ?>
                            <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle_four']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="inner-box mr_block_bttn mr_btton_a wps_overlay_style_1">
            <figure class="image-box wps_image_box">
                <?php if (wp_get_attachment_url($item['block_image_five']['id'])) : ?>
                    <img class="mr_product_thumb" src="<?php echo esc_url(wp_get_attachment_url($item['block_image_five']['id'])); ?>" alt="">
                <?php else : ?>
                    <div class="noimage"></div>
                <?php endif; ?>
            </figure>
            <div class="content-box">
                <div class="wps_project_icon view-btn">
                    <?php if (!empty($settings['block_plus_icon']['value'])) : ?>
                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_five']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                            <i class="<?php echo esc_attr($settings['block_plus_icon']['value']); ?>"></i>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($settings['block_link_icon']['value'])) : ?>
                ...
                <?php if ('style-1' === $settings['text_box_style'] || 'style-2' === $settings['text_box_style']) : ?>
                    <div class="text_outside_box">
                        <div class="text-box">
                            ...
                            <?php endif; ?>
                            <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle_five']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="inner-box mr_block_bttn mr_btton_a wps_overlay_style_1">
            <figure class="image-box wps_image_box">
                <?php if (wp_get_attachment_url($item['block_image_six']['id'])) : ?>
                    <img class="mr_product_thumb" src="<?php echo esc_url(wp_get_attachment_url($item['block_image_six']['id'])); ?>" alt="">
                <?php else : ?>
                    <div class="noimage"></div>
                <?php endif; ?>
            </figure>
            <div class="content-box">
                <div class="wps_project_icon view-btn">
                    <?php if (!empty($settings['block_plus_icon']['value'])) : ?>
                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_six']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                            <i class="<?php echo esc_attr($settings['block_plus_icon']['value']); ?>"></i>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($settings['block_link_icon']['value'])) : ?>
                ...
                <?php if ('style-1' === $settings['text_box_style'] || 'style-2' === $settings['text_box_style']) : ?>
                    <div class="text_outside_box">
                        <div class="text-box">
                            ...
                            <?php endif; ?>
                            <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle_six']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="inner-box mr_block_bttn mr_btton_a wps_overlay_style_1">
            <figure class="image-box wps_image_box">
                <?php if (wp_get_attachment_url($item['block_image_seven']['id'])) : ?>
                    <img class="mr_product_thumb" src="<?php echo esc_url(wp_get_attachment_url($item['block_image_seven']['id'])); ?>" alt="">
                <?php else : ?>
                    <div class="noimage"></div>
                <?php endif; ?>
            </figure>
            <div class="content-box">
                <div class="wps_project_icon view-btn">
                    <?php if (!empty($settings['block_plus_icon']['value'])) : ?>
                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_seven']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                            <i class="<?php echo esc_attr($settings['block_plus_icon']['value']); ?>"></i>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($settings['block_link_icon']['value'])) : ?>
                ...
                <?php if ('style-1' === $settings['text_box_style'] || 'style-2' === $settings['text_box_style']) : ?>
                    <div class="text_outside_box">
                        <div class="text-box">
                            ...
                            <?php endif; ?>
                            <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle_seven']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="inner-box mr_block_bttn mr_btton_a wps_overlay_style_1">
            <figure class="image-box wps_image_box">
                <?php if (wp_get_attachment_url($item['block_image_eight']['id'])) : ?>
                    <img class="mr_product_thumb" src="<?php echo esc_url(wp_get_attachment_url($item['block_image_eight']['id'])); ?>" alt="">
                <?php else : ?>
                    <div class="noimage"></div>
                <?php endif; ?>
            </figure>
            <div class="content-box">
                <div class="wps_project_icon view-btn">
                    <?php if (!empty($settings['block_plus_icon']['value'])) : ?>
                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_eight']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                            <i class="<?php echo esc_attr($settings['block_plus_icon']['value']); ?>"></i>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($settings['block_link_icon']['value'])) : ?>
                ...
                <?php if ('style-1' === $settings['text_box_style'] || 'style-2' === $settings['text_box_style']) : ?>
                    <div class="text_outside_box">
                        <div class="text-box">
                            ...
                            <?php endif; ?>
                            <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle_eight']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="inner-box mr_block_bttn mr_btton_a wps_overlay_style_1">
            <figure class="image-box wps_image_box">
                <?php if (wp_get_attachment_url($item['block_image_nine']['id'])) : ?>
                    <img class="mr_product_thumb" src="<?php echo esc_url(wp_get_attachment_url($item['block_image_nine']['id'])); ?>" alt="">
                <?php else : ?>
                    <div class="noimage"></div>
                <?php endif; ?>
            </figure>
            <div class="content-box">
                <div class="wps_project_icon view-btn">
                    <?php if (!empty($settings['block_plus_icon']['value'])) : ?>
                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_nine']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                            <i class="<?php echo esc_attr($settings['block_plus_icon']['value']); ?>"></i>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($settings['block_link_icon']['value'])) : ?>
                ...
                <?php if ('style-1' === $settings['text_box_style'] || 'style-2' === $settings['text_box_style']) : ?>
                    <div class="text_outside_box">
                        <div class="text-box">
                            ...
                            <?php endif; ?>
                            <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle_nine']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="inner-box mr_block_bttn mr_btton_a wps_overlay_style_1">
            <figure class="image-box wps_image_box">
                <?php if (wp_get_attachment_url($item['block_image_ten']['id'])) : ?>
                    <img class="mr_product_thumb" src="<?php echo esc_url(wp_get_attachment_url($item['block_image_ten']['id'])); ?>" alt="">
                <?php else : ?>
                    <div class="noimage"></div>
                <?php endif; ?>
            </figure>
            <div class="content-box">
                <div class="wps_project_icon view-btn">
                    <?php if (!empty($settings['block_plus_icon']['value'])) : ?>
                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_ten']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                            <i class="<?php echo esc_attr($settings['block_plus_icon']['value']); ?>"></i>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($settings['block_link_icon']['value'])) : ?>
                ...
                <?php if ('style-1' === $settings['text_box_style'] || 'style-2' === $settings['text_box_style']) : ?>
                    <div class="text_outside_box">
                        <div class="text-box">
                            ...
                            <?php endif; ?>
                            <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle_ten']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
