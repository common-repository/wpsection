...
<div class="wpsection-info-box wpsection-info-box-<?php echo esc_attr($settings['sec_class']); ?>">
    <div class="info-count"><?php echo esc_html($settings['info_count']); ?></div>
    <div class="icon-wrap">
        <?php if ('style1' === $settings['choose_media'] && !empty($settings['image']['id'])) : ?>
            <img src="<?php echo esc_url(wp_get_attachment_url($settings['image']['id'])); ?>" />
        <?php elseif ('style1' === $settings['choose_media']) : ?>
    ...
    <div class="wpsection-info-desc">
        <h3 class="wpsection-info-title"><?php echo esc_html($settings['title']); ?></h3>
        <div class="wpsection-info-text"><?php echo esc_html($settings['text']); ?></div>
