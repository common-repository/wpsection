          ...
          jQuery(document).ready(function($)
          {
            ...
            if ($(".three-item-carousel").length) {
              $(".three-item-carousel").owlCarousel({
				...
				autoplay: ' . wp_json_encode($settings['testi_slide_auto_loop'] === '1') . ',
            ...
            <?php foreach ($settings['repeater'] as $item) : ?>
                <div class="testimonial-block-one mr_product_block">
                    <div class="inner-box">
                     ...
                     <img class="wps_testi_thum" src="<?php echo esc_url(wp_get_attachment_url($item['block_image']['id'])); ?>" alt="<?php echo esc_attr(wp_kses($item['alt_text'], $allowed_tags)); ?>">
