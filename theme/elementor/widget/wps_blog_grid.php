...
//Title		
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .mr_block_subtitle a' => 'color: {{VALUE}} !important',
					'{{WRAPPER}} .mr_featured_block_subtitle:before' => 'background: {{VALUE}} !important',
...
<section class="blog-grid">
    <div class="auto-container">
        <div class="row clearfix">
            ...
            ?>
                <div class="col-lg-<?php echo esc_attr($settings['column']); ?> col-md-<?php echo esc_attr($settings['column_tab']); ?> col-sm-12 news-block">
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <figure class="image mr_product_thumb">
                                    <a class="mr_product_link" href="<?php echo esc_url(get_permalink()); ?>">
                                        
									<?php if ('style1' === $settings['thumb']) :
									    if (!empty(the_post_thumbnail())) :
									        the_post_thumbnail();
									    endif;
									elseif ('style2' === $settings['thumb']) : ?>
									    <?php if (!empty($meta_image) && isset($meta_image['id'])) :
									        $image_url = wp_get_attachment_url($meta_image['id']);
									        if ($image_url) : ?>
                                ...
                                <span class="post-date mr_post_date"><?php echo esc_html(get_the_date('d M')); ?></span>
                            </div>
                            <div class="lower-content">
                                ...
                                <h3 class="mr_block_title mr_featured_block"><a href="<?php echo esc_url(get_permalink()); ?>"><?php the_title(); ?></a></h3>
                                ...
                                <p class="mr_featured_block mr_f_block_text"><?php echo wp_kses_post(wp_trim_words(get_the_content(), $settings['text_limit'])); ?></p>
                                <div class="wps_read_button_area">
                                    <button class="wps_read_button">
                                        <a class="theme_btn_none" href="<?php echo esc_url(get_permalink()); ?>"><?php echo esc_html($settings['read_more_bttn']); ?></a>
                                    </button>
                                </div>
                            </div>
                        </div>
