        ...
        <?php if ('style1' === $settings['style']) : ?>
            <div class="wpsection-testimonial wpsection-testimonial-<?php echo esc_attr($settings['sec_class']); ?>">
                <div class="wpsection-testi-desc">
					<div class="wpsection-review-text"><?php echo esc_html( $settings['review_text'] ); ?></div>
...
<h3 class="wpsection-testi-name"><?php echo esc_html( $settings['subtitle'] ); ?></h3>
<span class="wpsection-testi-designation"><?php echo esc_html( $settings['text'] ); ?></span>
        ...
        <?php if ('style3' === $settings['style']) : ?>
            <div class="wpsection-testimonial wpsection-testimonial-<?php echo esc_attr($settings['sec_class']); ?>">
                ...
                <div class="wpsection-testi-info">
                    ...
                    <h3 class="wpsection-testi-name"><?php echo esc_html( $settings['subtitle'] ); ?>
</h3>
                    <span class="wpsection-testi-designation"><?php echo esc_html( $settings['text'] ); ?>
</span>
