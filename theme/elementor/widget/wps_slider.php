...
class wpsection_wpsection_Widget extends \Elementor\Widget_Base {
    ...
    $this->add_control(
            'style',
            array(
                'label' => __( 'Slider Style', 'wpsection' ),
...
$this->add_control(
	...
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .slider_path_container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				),
			)
		);
...
$this->add_control(
		...
		[
			'label'   => esc_html__( 'Slider Image Animation ', 'wpsection' ),
			'condition'    => array( 'slider_path_basic_show' => 'show' ),
			'type'    => Controls_Manager::SELECT,
			'default' => '1',
			'options' => array(
				'slider_path_animation_slider_style_1'   => esc_html__( 'Animations Style 01', 'wpsection' ),
				'slider_path_animation_slider_style_2'   => esc_html__( 'Animations Style 02', 'wpsection' ),
				'slider_path_animation_slider_style_3'   => esc_html__( 'Animations Style 03', 'wpsection' ),
...
// Title Slider Setting 001 	==================	
	...
	$this->add_control(
		...
		[
			...
			'default' => '1',
			'options' => array(
				'slider_path_animation_title_style_1'   => esc_html__( 'Animations Style 01', 'wpsection' ),
				'slider_path_animation_title_style_2'   => esc_html__( 'Animations Style 02', 'wpsection' ),
				'slider_path_animation_title_style_3'   => esc_html__( 'Animations Style 03', 'wpsection' ),
...
//End Dot
  ...
  <?php if ('style-1' === $settings['style']) : 
            $style_folder = __DIR__ . '/wps_slider/style-1.php';
  ...
  <?php if ('style-2' === $settings['style']) : 
            $style_folder = __DIR__ . '/wps_slider/style-2.php';
            if (is_readable($style_folder)) {
                require $style_folder;
            } else {
                echo " Style file  not found or could not be read.";
  ...
  <?php if ('style-3' === $settings['style']) : 
            $style_folder = __DIR__ . '/wps_slider/style-3.php';
            if (is_readable($style_folder)) {
                require $style_folder;
            } else {
                echo " Style file  not found or could not be read.";
