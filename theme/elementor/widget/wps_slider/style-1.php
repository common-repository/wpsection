...
if ($(".wpsection_banner-carousel-one").length) {
    $(".wpsection_banner-carousel-one").owlCarousel({
		   ...
		   animateOut: "fadeOut",
			...
			autoplay: ' . wp_json_encode($settings['hero_slide_auto_loop'] === '1') . ',
	   ...
	   responsive:{
                    ...
                    600:{
                        items: ' . wp_json_encode($settings['hero_wps_columns_tab']) . ' 
                    },
                    900:{
                        items: ' . wp_json_encode($settings['hero_wps_columns_tab']) . ' 
                    },
                    1024:{
                        items:' . wp_json_encode($settings['hero_wps_columns']) . ' 
                    },
                }
