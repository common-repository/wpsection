 ...
 <section class="wps_project_gallery">
    <div class="auto-container">
        <div class="project-section">
            ...
            <div class="<?php echo esc_attr($settings['enable_slide'] ? 'project-carousel owl-carousel slider_path owl-theme owl-dots owl-nav' : 'row'); ?>">

                <?php foreach ($settings['repeater'] as $item) : ?>
                    <div class="wp_project_block project-block-one <?php echo esc_attr($settings['enable_slide'] ? '' : $columns_markup_print); ?>">
                            ...
                            <div class="content-box">
                                ...
                                <div class="wps_project_icon view-btn">
                                        ...
                                        <a href="<?php echo esc_url(wp_get_attachment_url($item['block_image_one']['id'])); ?>" class="wps_project_plus_icon lightbox-image" data-fancybox="gallery">
                                            <i class="<?php echo esc_attr($item['block_plus_icon']['value']); ?>"></i>
                                        </a>
                                 
                                   
                                        <a href="<?php echo esc_url($item['block_btnlink_x_one']['url']); ?>" class="wps_project_expand_icon wps_image_link">
                                            <i class="<?php echo esc_attr($item['block_link_icon']['value']); ?>"></i>
                                        </a>
                                 
                                </div>

                                <div class="text-box">
                                    <p class="mr_block_subtitle mr_featured_block_subtitle"><?php echo esc_html($item['block_subtitle']); ?></p>
                                    <h3 class="mr_block_title mr_featured_block"><a href="<?php echo esc_url($item['block_btnlink_x']['url']); ?>"><?php echo wp_kses_post($item['block_title']); ?></a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
