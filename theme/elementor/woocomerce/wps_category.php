...
$this->add_control(
            ...
            array(
                ...
                'default' => 'show',
                'selectors' => array(
                    '{{WRAPPER}} .wps_cat_thumb' => 'display: {{VALUE}} !important',
                ),
            )
        );      
    $this->add_control( 'thumb_cat_width',
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .wps_cat_thumb' => 'width: {{SIZE}}{{UNIT}};',
                        ]
		    ...
		    $this->add_control( 'thumb_cat_height',
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .wps_cat_thumb' => 'height: {{SIZE}}{{UNIT}};',
                        ]
    ...
    $this->add_control(
            ...
            array(
                ...
                'selectors' => array(
                    ...
                    '{{WRAPPER}} .wps_cat_thumb ' => 'text-align: {{VALUE}}',
                ),
            )
        );          
    ...
    $this->add_control(
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .wps_cat_thumb' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ),
            )
        );
    ...
    $this->add_control(
            ...
            array(
                ...
                'size_units' =>  ['px', '%', 'em' ],
                'selectors' => array(
                    '{{WRAPPER}} .wps_cat_thumb' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ),
            )
        );
        ...
        $this->add_group_control(
            ...
            array(
                'name' => 'thumbnail_catx_border',
                    'condition'    => array( 'show_thumbnail' => 'show' ),
                'selector' => '{{WRAPPER}} .wps_cat_thumb',
            )
        );
            ...
            array(
                ...
                'size_units' =>  ['px', '%', 'em' ],
                'selectors' => array(
                    '{{WRAPPER}} .wps_cat_thumb' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ),
            )
        );  
        $this->end_controls_section();
...
//Product Bottom ARea
    ...
    $this->add_control(
            ...
            array(
                ...
                'default' => 'show',
                'selectors' => array(
                    '{{WRAPPER}} .mr_product_block .wps_cat_thumb' => 'display: {{VALUE}} !important',
                ),
            )
        );  
...
$this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mr_product_block .wps_cat_thumb' => 'min-height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .mr_product_block .wps_cat_thumb' => 'background: {{VALUE}} !important',
                ),
            )
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .mr_product_block .wps_cat_thumb' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .mr_product_block .wps_cat_thumb' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ),
            )
        );
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .mr_product_block .wps_cat_thumb',
            ]
        );
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'size_units' =>  ['px', '%', 'em' ],
                'selectors' => array(
                    '{{WRAPPER}} .mr_product_block .wps_cat_thumb' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
                ),
            )
        );
...
*/	
  ...
  <?php if ('style-1' === $settings['style']) : 
            $style_folder = __DIR__ . '/wps_category/style-1.php';
