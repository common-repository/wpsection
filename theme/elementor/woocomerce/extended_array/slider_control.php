...
$this->add_control(
  ...
  $this->add_group_control(
            \Elementor\Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'block_arrow_hover_shadow',
                'label' => esc_html__( 'Box Shadow', 'wpsection' ),
                'selector' => '{{WRAPPER}} .slider_path .owl-nav button:hover',
            ]
        );
	...
	$this->add_control(
		...
		$this->add_control(
	     ...
	     $this->add_group_control(
            \Elementor\Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'block_arrow_1_shadow',
                'label' => esc_html__( 'Box Shadow', 'wpsection' ),
                'selector' => '{{WRAPPER}} .slider_path .owl-theme .owl-dots',
            ]
        );			
			...
			array(
				...
				$this->add_control( 'slider_path_sweep_dot_vertical',
					[
						...
						'selectors' => [
							'{{WRAPPER}} .wps_slide_sweeper_two  .swiper-pagination' => 'bottom: {{SIZE}}{{UNIT}};',
